...
public class Chamado {
	...
	@JsonFormat(pattern = "dd/MM/yyyy")
	private LocalDate dataFechamanto = LocalDate.now();
	...
	public LocalDate getDataFechamanto() {
		return dataFechamanto;
	}

	public void setDataFechamanto(LocalDate dataFechamanto) {
		this.dataFechamanto = dataFechamanto;
	}
